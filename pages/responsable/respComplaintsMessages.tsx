...
const respComplaintsMessages: PageWithSecondaryLayoutType = () => {
        ...
        <div className="px-2 pt-8">
          <div className="flex items-center gap-3 bg-secondary/20 py-2 px-0.5">
            ...
            <p className=" font-bold">
              جميع شكايات مسؤول المعلومات <span className="font-bold">10</span>
            </p>
          </div>
        </div>
        <div className=" flex flex-1 border-r-2">
          <div className=' overflow-y-scroll'>
            <div className="border-b-2 px-2 pt-4 pb-8">
              ...
              شكايات مسؤول المعلومات :<span className="font-bold"> 10</span>
              </p>
            </div>
            <div>
...
export default respComplaintsMessages

respComplaintsMessages.getLayout = SecondaryLayout
