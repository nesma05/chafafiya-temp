...
const CheckComplaintComity: NextPage = () => {
  ...
  return (
    <div className="bg-red flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl leading-10 font-extrabold text-gray-900">
          تقديم شكاية للجنة الحق في الحصول على المعلومات
          </h2>
        </div>
...
export default CheckComplaintComity
